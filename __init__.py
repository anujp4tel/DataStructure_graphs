...
<html lang="en">
  ...
  <title>PythonDataStructuresLibrary/__init__.py at master · cicirello/PythonDataStructuresLibrary</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjA1Nzk4OTc1OjhlN2U2ZWFhNDQ0Yzk0NTA4ZTAzNTdkOTIwNWM5NTBjOTY2MDA1NWJmOTJhNDUwOTllYTZkMjI0NWEwMmNkYWY=--98bebb418e78a991d13eef799fc68faf39949a95">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="CC16:0BBE:48C745C:7222E93:59EFCC50" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="anujp4tel">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta content="762030" name="octolytics-dimension-user_id" /><meta content="cicirello" name="octolytics-dimension-user_login" /><meta content="106332426" name="octolytics-dimension-repository_id" /><meta content="cicirello/PythonDataStructuresLibrary" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="106332426" name="octolytics-dimension-repository_network_root_id" /><meta content="cicirello/PythonDataStructuresLibrary" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/cicirello/PythonDataStructuresLibrary/blob/master/lib/__init__.py" data-pjax-transient>
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/cicirello/PythonDataStructuresLibrary/search" class="js-site-search-form" data-scoped-search-url="/cicirello/PythonDataStructuresLibrary/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/cicirello/PythonDataStructuresLibrary/blob/master/lib/__init__.py" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="lLyaYmPSAsQtByOS0jaRybWtt2V4DFyNAR6ts/CNI+Stv8Vpjobhr6/ahtEw2vpvhS3iP64TB6IJ+pvb1+o9zQ==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ap0YLqqIU9FrbxmcP7H8fQfHB2i9r2XFA/YtwoMQTxdTnkclR9ywuumyvN/dXZfbN0dSMmuwPuoLEhuqpHdRPg==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="0w9DYNUWn6Dw8TH0F979PQb02BvNvCwx/Dbd1sN2IsCSZ3W+URWbd28ubacIIfwmpeqa89fsDOs43OrRHCnkbQ==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="106332426" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/cicirello/PythonDataStructuresLibrary/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="KpuX0PcVsXOIMNKi7lHjaAleiGxGh2NXzkPximISMn364lsuzAbXQJutCxnXfKgdz82e613CS7R0/1CUZUUPpg==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/cicirello/PythonDataStructuresLibrary/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="5zniQmJng5gCmhb9o7jmhtDXcp9ZiuvJ9q+8sEYlwz5qeMZLt5+tE0UAUg+1U35kQjBEsPbDFMP0hWbchOyWLg==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/cicirello/PythonDataStructuresLibrary/blob/5576f4b03caa177be1c4ef4a6c15efd6810c309b/lib/__init__.py" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:512841a7392bc95c10c20bb3d366801e -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/cicirello/PythonDataStructuresLibrary/blob/master/lib/__init__.py"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/cicirello/PythonDataStructuresLibrary/commit/4b26ce6e7d22f355b246ddd0e4b83e45c2fd8323" data-pjax>
          4b26ce6
        </a>
        <relative-time datetime="2017-10-13T16:03:34Z">Oct 13, 2017</relative-time>
      </span>
      <div>
        ...
        <a href="/cicirello" class="user-mention" rel="author">cicirello</a>
          <a href="/cicirello/PythonDataStructuresLibrary/commit/4b26ce6e7d22f355b246ddd0e4b83e45c2fd8323" class="message" data-pjax="true" title="added pq unit tests">added pq unit tests</a>
      </div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/cicirello/PythonDataStructuresLibrary/raw/master/lib/__init__.py" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/cicirello/PythonDataStructuresLibrary/blame/master/lib/__init__.py" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/cicirello/PythonDataStructuresLibrary/commits/master/lib/__init__.py" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>

        <a class="btn-octicon tooltipped tooltipped-nw"
           href="x-github-client://openRepo/https://github.com/cicirello/PythonDataStructuresLibrary?branch=master&amp;filepath=lib%2F__init__.py"
           aria-label="Open this file in GitHub Desktop"
           data-ga-click="Repository, open with desktop, type:windows">
            <svg aria-hidden="true" class="octicon octicon-device-desktop" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M15 2H1c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1h5.34c-.25.61-.86 1.39-2.34 2h8c-1.48-.61-2.09-1.39-2.34-2H15c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1zm0 9H1V3h14v8z"/></svg>
        </a>

        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/cicirello/PythonDataStructuresLibrary/edit/master/lib/__init__.py" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dy7V6XFPjFzMQSRmAjwSRdh1FywkIbTWBXIKqOzPAZ0au+KYXmg+yg9nNmtuaH/XfRIqnylAWmPq9+IM/kXuCA==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/cicirello/PythonDataStructuresLibrary/delete/master/lib/__init__.py" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="RmMxcEfzOxJVU+ULGi5p/G2T4CguuRiv/iIZVTgUTa+Vf2quT9fO/8SOS0dPMAIz0hmdKkh9rBC6kVPWGnX4RA==" /></div>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a href="/cicirello/PythonDataStructuresLibrary/blame/5576f4b03caa177be1c4ef4a6c15efd6810c309b/lib/__init__.py" class="dropdown-item js-update-url-with-hash" id="js-view-git-blame">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2017 <span title="0.19026s from unicorn-2834762624-w8vw2">GitHub</span>, Inc.</li>
